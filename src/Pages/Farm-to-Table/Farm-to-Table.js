      ...
      <div className = "main-content">
        ...
        <div className = "imgcont">
          ...
          <ul className = "bulletlist">
            ...
            <li id = "lastitem" className = "bulletlistitem">The farm to table movement became more popular as people have started to care more about fresh, seasonal food and supporting small, local farms. Many supporters of the movement say their goal is to fix problems like the lack of fresh local options, the bad taste of food shipped long distances, and the decline of small family farms. At the end of the day, the farm to table movement is all about reconnecting with food and its producers.</li>
          </ul>
        </div>
        <div className = "imgcont">
          <ul className = "bulletlist">
